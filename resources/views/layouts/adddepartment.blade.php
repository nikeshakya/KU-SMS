...
@section('bodycontent')
<div class="container">
				{!! Form::open(array('class'=>'form-horizontal', 'action'=>'DepartmentController@registerdepartment','method'=>'post')) !!} 
						@if ($errors->has())
						...
						@endif
						<fieldset>
						<legend>Register a Department</legend>
						<div class="control-group">
						{!! Form::label('departmentcode', 'Department Code:', array('class' => 'control-label')) !!}
						<div class="controls">
						{!! Form::text('departmentcode', null, ['placeholder'=>'Enter code (eg. DoCSE)', 'required']) !!}
						</div>
						</div>
						<div class="control-group">
						{!! Form::label('departmentname', 'Name:', array('class' => 'control-label')) !!}
						<div class="controls">
							{!! Form::text('departmentname', null, ['placeholder'=>'Enter Department Name', 'required']) !!}
						</div>
						</div>
						<div class="control-group">
						{!! Form::label('departmentrooms', 'Total available rooms:', array('class' => 'control-label')) !!}
						<div class="controls">
							{!! Form::number('departmentrooms', 1, ['required', 'min'=>'1', 'max'=>'8']) !!}
						</div>
						</div>
						<div class="control-group">
						<div class="controls">
