...
<div class = "span9">		
						...
						{!! Form::open(array('action'=>'CourseDetailController@withdrawclass', 'method'=>'post')) !!} 
				...
				<tr>
				  ...
				  <th>Select</th>
						...
						<tr> 
								...
								<td>{!! Form::checkbox('set_code[]', $offeredcourse->id) !!}</td>
						...
						<div class="controls">
							{!! Form::submit('Withdraw Courses', ['class'=>'btn btn-primary','value'=>'withdraw', 'name'=>'withdraw']) !!}
						</div>
						</div>
	{!! Form::close() !!}					
</div>
